...
public class DetailActivity extends ActionBarActivity {
    ...
    public static void startActivity(Activity activity, int board_id, String detail_url) {
        Intent intent = new Intent(activity, DetailActivity.class);
        intent.putExtra(ARG_BOARD_ID, board_id);
        intent.putExtra(ARG_DETAIL_URL, detail_url);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDetail_url = bundle.getString(ARG_DETAIL_URL);
        mBoard_id = bundle.getInt(ARG_BOARD_ID);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return DetailFragment.newInstance(mBoard_id, mDetail_url);
        }
